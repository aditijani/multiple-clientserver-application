 ...
 *        Interface Operation This class represent the Subtract operation
 *        service and how the operation must be done for this particular
 *        operation
 *
 */
public class SubOperationImpl extends UnicastRemoteObject implements Operation {
 
	/**
	 * class constructor
	 * @throws RemoteException
	 */
	public SubOperationImpl() throws RemoteException {       
    }
    ...
    public int doOperation(int num1, int num2) throws RemoteException {
        System.out.println("Sub operation is done and the result sent back to the client");
        return num1-num2;
    }
